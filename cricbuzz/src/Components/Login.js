          ...
          <div className="modal show d-block " tabIndex="-1" role="dialog">
            <div className="modal-dialog modal-fullscreen" role="document">
              <div className="modal-content ">
                <div className="modal-heade text-end">
                ...
                <div className="modal-body col-lg-4 col-md-4 col-10  mx-auto align-content-center">
                  <form className="p-3 border shadow rounded-3" onSubmit={signIn}>
                    ...
                    <h5 className="text-center text-primary fw-bold mb-4">Login to Cricbuzz</h5>
                      <input
                        type="email"
                        name="email"
                    ...
                    <div className="text-center sigupcricbuzz">
                      <button type="submit" className="btn btn-success w-100 mb-4">
                        Sign In &nbsp;<i class="fa-solid fa-right-to-bracket signin_symbol"></i>
                      </button>
